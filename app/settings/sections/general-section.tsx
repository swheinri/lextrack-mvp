...
export default function GeneralSection(props: {
  ...
  // ✅ neu (für prod: WIP-Karten ausblendbar)
  showWip: boolean;
})  {
  const {
    t,
  ...
  // Fallbacks, falls t mal kurz undefined ist
  const TT = useMemo(() => {
    const base = t ?? {};
    const fb = isDe
      ? {
  ...
  // ✅ Presets sind JETZT im Lesemodus-Kasten integriert (keine extra WIP-Kachel mehr)
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ✅ DIE 4 KACHELN (das hat dir gefehlt) */}
      ...
      {/* ✅ WIP-Karten (Vorlesen/Blaulichtfilter) NUR lokal */}
      {showWip && (
